...
const Contact = () => {
    ...
    return (
        <>
            <SEO
                title='Kyle Rachman | Contact Me'
                url='https://kylerachman.dev/contact'
                image={phoenixv5}
                imageAlt="Phoenix logo, KR"
                description="If you want to get started on building or working on a project together, get in touch with me here!"
            ></SEO>
